<html>
	<head>
		...
		<script language="javascript" src="${resource(dir: 'js', file: 'jquery.dataTables.min.js')}"></script>
		<script language="javascript" src="${resource(dir: 'js', file: 'datatable.js')}"></script>
		<g:layoutHead/>
	</head>
	<body>
		<div class="wrapper">
		...
		<div id="communityPalette" class="shadow">
			<g:layoutBody/>
		</div>
	</body>
</html>
